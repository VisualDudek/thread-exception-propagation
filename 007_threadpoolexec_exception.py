...
def task_that_fails(task_id, should_fail=True):
...
def demonstrate_exception_handling():
    ...
    with ThreadPoolExecutor(max_workers=3) as executor:
        ...
        future1 = executor.submit(task_that_fails, 1, True)   # Will fail
        future2 = executor.submit(task_that_fails, 2, True)   # Will fail  
        future3 = executor.submit(task_that_fails, 3, False)  # Will succeed
